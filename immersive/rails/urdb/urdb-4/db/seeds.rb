...
days_of_summer = Movie.create(
  ...
  image: "http://upload.wikimedia.org/wikipedia/en/thumb/d/d1/Five_hundred_days_of_summer.jpg/220px-Five_hundred_days_of_summer.jpg",
  trailer: "PsD0NpFSADM",
...
yes_man = Movie.create(
  title: "Yes Man",
  image: "http://upload.wikimedia.org/wikipedia/en/thumb/7/71/YesMan2008poster.jpg/220px-YesMan2008poster.jpg",
  trailer: "rvpsiIe2vBE",
  description: "A guy challenges himself to say 'yes' to everything for an entire year."
)

jim_carrey = Star.create(name: 'Jim Carrey',
                      headshot: 'http://ia.media-imdb.com/images/M/MV5BMTQwMjAwNzI0M15BMl5BanBnXkFtZTcwOTY1MTMyOQ@@._V1_SY317_CR22,0,214,317_.jpg',
...
zooey = Star.create(name: 'Zooey Deschanel',
                      headshot: 'http://ia.media-imdb.com/images/M/MV5BMTQ4Mjk3NDA1MF5BMl5BanBnXkFtZTcwMDAyNTYxNw@@._V1_SY317_CR104,0,214,317_.jpg',
...
joseph = Star.create(name: 'Joseph Gordon-Levitt',
                      headshot: 'http://ia.media-imdb.com/images/M/MV5BMTQzOTg0NTkzNF5BMl5BanBnXkFtZTcwNTQ4MTcwOQ@@._V1_SY317_CR35,0,214,317_.jpg',
